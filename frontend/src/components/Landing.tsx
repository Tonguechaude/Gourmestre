      ...
      <div className="card hover-lift animate-fade-in-up" style={{ 
        ...
        <div style={{ marginBottom: 'var(--space-3xl)' }}>
          <h1 className="text-display" style={{ marginBottom: 'var(--space-lg)' }}>
            Bienvenue sur <br/>
            <span style={{ color: 'rgb(var(--color-accent))' }}>Gourmestre</span>
          </h1>
          <p className="text-body" style={{ maxWidth: '24rem', margin: '0 auto' }}>
            Découvrez, notez et organisez vos restaurants favoris en toute simplicité. Votre carnet de bord culinaire personnel.
          </p>
        </div>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--space-md)' }}>
          ...
          <button onClick={() => navigate('/register')} className="btn btn-secondary" style={{ width: '100%' }}>
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
