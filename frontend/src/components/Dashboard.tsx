                ...
                {loading ? (
                  ...
                  >
                    ...
                    <p className="text-caption mt-2">
                      Ajoutez vos premiers favoris depuis le tableau de bord !
                    </p>
                  </div>
                )}
              </div>
              ...
              <div className="space-y-4">
                {loading ? (
                  ...
                  >
                    ...
                    <p className="text-body-sm">
                      Aucun restaurant ajouté pour le moment.
                    </p>
                    <p className="text-caption mt-2">
          ...
          <section>
            <div className="card" style={{ padding: "var(--space-2xl)" }}>
              <header className="mb-8">
                ...
                <p className="text-body-sm">
                  Restaurants que vous souhaitez essayer
                </p>
              </header>
              ...
              <div className="space-y-4">
                {loading ? (
                  ...
                  >
                    ...
                    <p className="text-caption mt-2">
                      Utilisez le formulaire ci-dessus pour ajouter votre
                      premier restaurant !
                    </p>
                  </div>
                )}
