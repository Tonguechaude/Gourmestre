...
const DashboardSidebar: React.FC<DashboardSidebarProps> = ({
  ...
  return (
    <nav
      className={`${isMobile ? "w-full" : "w-72 flex-shrink-0"} bg-white ${!isMobile ? "border-r" : ""} flex flex-col`}
      style={{ borderColor: "var(--border-subtle)" }}
    >
      {/* Logo & Title - Only show on desktop */}
      {!isMobile && (
        <div
          ...
          <ul className="space-y-2">
            ...
            <li>
              ...
              >
                ...
                <span
                  className="text-caption bg-gray-100 px-2 py-1 rounded-full ml-auto"
                  style={{
      ...
      <div
        className={`${isMobile ? "p-4" : "p-6"} border-t`}
        style={{ borderColor: "var(--border-subtle)" }}
      >
        <button
          onClick={onLogout}
